...
export function CourseCard({ 
  ...
  return (
    <div
      onClick={() => onClick(id)}
      className="bg-[#1B263B] rounded-xl overflow-hidden hover:bg-[#415A77] transition-all duration-300 hover:scale-105 hover:shadow-xl group cursor-pointer"
    >
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 right-3 bg-black bg-opacity-50 rounded-full px-2 py-1 text-xs flex items-center">
          <Star className="w-3 h-3 text-yellow-400 mr-1 fill-current" />
          {rating}
        </div>
        {progress === 100 && (
          <div className="absolute top-3 left-3 bg-green-50a0 rounded-full p-1">
